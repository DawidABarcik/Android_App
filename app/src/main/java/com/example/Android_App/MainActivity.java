    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_savedjobs:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new SavedJobsFragment()).commit();
                break;
            case R.id.nav_joboffers:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new JobOffersFragment()).commit();
                break;
            case R.id.nav_myinfo:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new MyInfoFragment()).commit();
                break;
            case R.id.nav_jobhistory:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new JobHistoryFragment()).commit();
                break;
            case R.id.nav_share:
